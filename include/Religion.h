...
class Religion {
    public:
        Religion();
        Religion(string nom, string description, string unite[2], string batiment[2], float eUnite, float eBatiment[4][2]);
        ...
        float getEUnite() const { return this->eUnite; }
